...
from utils_capacity.report_capacity import report_capacity

def capacity_export_section(df_filtered, client_name="Write your client name", logo_path="logo.png"):
    """
    ...
    - All key KPIs (SLA, MTTR, Open capacitys)
    ...
    if generate_btn:
        ...
        with st.spinner("Building Service Desk Executive Report... please wait."):
            try:
                pdf_bytes, docx_bytes = report_capacity(
                    df=df_filtered,
                ...
                st.download_button(
                    ...
                    data=pdf_bytes,
                    file_name=f"ITInfrastructureCapacityOptimizationAnalysis_ExecutiveReport_{client_name}.pdf",
                ...
                if docx_bytes:
                    st.download_button(
                        ...
                        data=docx_bytes,
                        file_name=f"ITInfrastructureCapacityOptimizationAnalysis_ExecutiveReport_{client_name}.docx",
