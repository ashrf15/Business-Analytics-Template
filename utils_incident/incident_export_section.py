...
from utils_incident.report_incident import report_incident

def incident_export_section(df_filtered, client_name="Write your client name", logo_path="logo.png"):
    """
    ...
    if generate_btn:
        ...
        with st.spinner("Building Incident Management Executive Report... please wait."):
            try:
                pdf_bytes, docx_bytes = report_incident(
                    df=df_filtered,
                ...
                st.download_button(
                    ...
                    data=pdf_bytes,
                    file_name=f"IncidentManagement_ExecutiveReport_{client_name}.pdf",
                ...
                if docx_bytes:
                    st.download_button(
                        ...
                        data=docx_bytes,
                        file_name=f"IncidentManagement_ExecutiveReport_{client_name}.docx",
        ...
        st.info("Click **Generate Executive Report** to export all Incident Management insights.")
