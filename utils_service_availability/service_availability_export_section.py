...
from utils_service_availability.report_service import report_service

def service_availability_export_section(df_filtered, client_name="Write your client name", logo_path="logo.png"):
    """
    ...
    if generate_btn:
        ...
        with st.spinner("Building service_availability Management Executive Report... please wait."):
            try:
                pdf_bytes, docx_bytes = report_service(
                    df=df_filtered,
                ...
                st.download_button(
                    ...
                    data=pdf_bytes,
                    file_name=f"service_availabilityManagement_ExecutiveReport_{client_name}.pdf",
                ...
                if docx_bytes:
                    st.download_button(
                        ...
                        data=docx_bytes,
                        file_name=f"ITServiceAvailability_ExecutiveReport_{client_name}.docx",
        ...
        st.info("Click **Generate Executive Report** to export all IT Service Availability Report insights.")
